...
\usepackage{listings}
\usepackage{tikz}
\usetikzlibrary{arrows,positioning,shapes.symbols,shapes.callouts,shapes.geometric,patterns,calc} 
\tikzset{
    vertex/.style = {
        circle,
        fill            = black,
...
\projectinfo{
  ...
  acknowledgment={Zde je možné uvést poděkování vedoucímu práce a těm, kteří
  poskytli odbornou pomoc a Nejakému Fridovi z Facebooku za převod šablony do utf8 (Diky Frido).} % nepovinne
}
