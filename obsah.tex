...
Subject of this thesis project is constructing a C programming language compiler for the soft-core processor PicoBlaze-6.
    ...
    After in introduction to PicoBlaze in Section \ref{processor} and explaining the basic principles of compiler design in section \ref{compiler}, the available existing and open source C language compiler front-ends are enumerated in Section \ref{frontend}.

    Next, the previous projects implementing a compiler for the PicoBlaze processor, are listed in Section \ref{previous}.
...
It's necessary to evaluate the overall success of a compiler project by testing it a comparing to alternative. In this section, the testing and comparison methods are described.
    ...
    \hline
            &PBCCv3           &PBCCv2 (J. Horník)&PBCC (B. Nováček)&PCComp\\
\hline
