...
In this chapter, the most vital parts and terms in construction of a compiler are discussed, with focus on C language.
    ...
    \section{Intermediate Code}
            ...
            Most compilers use \emph{three address code} as their intermediate language. This puts them close to many processor architectures, such as \emph{ARM}, that uses a form of \emph{three address code} as its assembly language. In contrary, other architectures, like \emph{x86}, or, \emph{PicoBlaze}, use only two operands in their assembly.
